...
import com.example.doanquanlynhathuoc.Adapter.Adapter_PhieuMuaThuocTraCuu;
...
public class NVK_TraCuuPhieuMuaThuoc extends AppCompatActivity {
    ...
    Adapter_PhieuMuaThuocTraCuu adapterPhieuMuaThuocTraCuu;
    ...
    private void setControl() {
        ...
        adapterPhieuMuaThuocTraCuu = new Adapter_PhieuMuaThuocTraCuu(getApplicationContext(), R.layout.cus_tom_phieu_mua_thuoc_tra_cuu, arrDanhSach);

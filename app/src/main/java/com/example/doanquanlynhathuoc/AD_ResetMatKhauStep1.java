...
public class AD_ResetMatKhauStep1 extends AppCompatActivity {
    ImageButton imTroVe,imRefresh;
    EditText edTimKiem;
    ListView lvDSNV;
    Adapter_NhanVien_Reset_MatKhau adapter_nhanVien;
    ArrayList<NhanVien> arrNhanVien = new ArrayList<>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ad_reset_mat_khau_step1);
        setControl();
        setEvent();
    }
    ...
    private void setEvent() {
        ...
        edTimKiem.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                Adapter_NhanVien_Reset_MatKhau adapter_nhanVien = new Adapter_NhanVien_Reset_MatKhau(getApplicationContext(), R.layout.custom_nhanvien_reset_matkhau, kq);
    ...
    private void setControl() {
        ...
        lvDSNV = findViewById(R.id.lvDanhSachNhanVien1);

        adapter_nhanVien = new Adapter_NhanVien_Reset_MatKhau(getApplicationContext(),R.layout.custom_nhanvien_reset_matkhau,arrNhanVien);
        lvDSNV.setAdapter(adapter_nhanVien);
    }
}
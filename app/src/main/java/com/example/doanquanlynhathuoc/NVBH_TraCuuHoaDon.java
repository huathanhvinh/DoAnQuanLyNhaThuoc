...
public class NVBH_TraCuuHoaDon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nvbh_tra_cuu_hoa_don);
        setControl();
        setEvent();
    }
    ...
    private void setEvent() {
        ...
        imTimKiem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkNgay != 0) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(NVBH_TraCuuHoaDon.this);
                        ...
                        public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                            ...
                            try {
                                ...
                                if (ngayLap.compareTo(ngayBatDau1) >= 0 && ngayLap.compareTo(ngayKetThuc1) <= 0) {
                                    ...
                                    tvTongPhieu.setText(arrDanhSach.size() + " hóa đơn");
